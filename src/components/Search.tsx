...
import { createSignal, onCleanup, Show, For, type Accessor } from "solid-js";
...
const [searchData, setSearchData] = createSignal<FoundComposers>([]);
const [searchResults, setSearchResults] = createSignal<FoundComposers>([]);
...
async function fetchSearchData(): Promise<void> {
  setSearchData(await getSearchComposersData());
}
